...
class UserController extends Controller
{
	...
	public function indexAction()
	{
		...
		$this->_view->slbFilterGroup = $this->_model->itemInSelectBox($this->_arrParam, ['task' => 'add-default']);
	...
	public function formAction()
	{
		...
		$this->_view->slbGroup = $this->_model->itemInSelectBox($this->_arrParam, ['task' => 'add-default']);
	...
	public function ajaxChangeGroupAction()
	{
		...
		$result = $this->_model->ajaxChangeGroup($this->_arrParam);
		echo json_encode($result);
	}
